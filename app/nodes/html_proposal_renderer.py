...
class HorizonHTMLProposalRendererInput(BaseModel):
    """Pydantic model defining the HorizonHTMLProposalRendererInput shape."""
    pass


class HorizonHTMLProposalRendererConfig(BaseModel):
    """Pydantic model defining the HorizonHTMLProposalRendererConfig shape.
...
class HorizonHTMLProposalRendererOutput(BaseModel):
    """Pydantic model defining the HorizonHTMLProposalRendererOutput shape.
...
class HorizonHTMLProposalRenderer(NodeType):
    """Workflow node type implementing the HorizonHTMLProposalRenderer capability."""
